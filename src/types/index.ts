...
export interface GeneratedPost { id: string; content: string; format: string; goal: string; pattern: string; whyItWorks: string; hook: string; recommendedTime: string; confidence: number; status: PostStatus }
...
export interface XPost { id: string; text: string; createdAt: string; publicMetrics: { likeCount: number; replyCount: number; repostCount: number; impressionCount: number } }
